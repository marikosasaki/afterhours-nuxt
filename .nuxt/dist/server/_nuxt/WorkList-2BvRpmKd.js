...
const _imports_0 = "" + __buildAssetsURL("portforio7.wRaNpPkP.png");
const _imports_1 = "" + __buildAssetsURL("portforio2.6XQk9MWe.png");
const _imports_2 = "" + __buildAssetsURL("portforio3.L2s4T5FI.png");
const _imports_3 = "" + __buildAssetsURL("portforio1.Mwp7OmXI.png");
const _imports_4 = "" + __buildAssetsURL("portforio4.eK9vB-OY.png");
const _imports_5 = "" + __buildAssetsURL("portforio5.hSYp3f7n.png");
const _imports_6 = "" + __buildAssetsURL("portforio6.y2kidhpp.png");
const _sfc_main = {
  props: ["page"],
  data() {
    return {
...
//# sourceMappingURL=WorkList-2BvRpmKd.js.map
